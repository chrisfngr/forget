...
export save_name="/home/rongfeng3-c/LLM/forget/results/mllm_cl_scienceqa_odrder_2/inference_results_vllm_${DATASET_NAME_SHORT}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.json"
